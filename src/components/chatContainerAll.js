import { chatWithEveryone } from "../lib/API.js";

export const chatContainerAll = () => {
  ...
  h2Credential.textContent = "Habla con todos nuestros piratas";

  const totalConversation = [];
  buttonSend.addEventListener("click", () => {
    const inputUser = inputPrompt.value;
    chatWithEveryone(inputUser)
      .then((response) => {
